...
public class MfaController {
	...
	public void processSecondFactor(@RequestParam("code") String code,
			HttpServletRequest request, HttpServletResponse response) throws Exception {
		MfaAuthenticationHandler handler = new MfaAuthenticationHandler("/home");
		MfaAuthentication authentication = HolderSecurity.getData();
		if (code.equals("huy")) {
	...
	// public void processThirdFactor(@RequestParam("answer") String answer,
	// HttpServletRequest request, HttpServletResponse response) throws Exception {
	// Authentication authentication =
	// SecurityContextHolder.getContext().getAuthentication();
	// String encodedAnswer = getAnswer(new MfaAuthentication(authentication));
